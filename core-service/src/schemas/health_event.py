...
class HealthEventBase(BaseModel):
    ...
    disease_name: Optional[str] = Field(None, max_length=100)  # ✅ OPCIONAL
    medicine_name: Optional[str] = Field(None, max_length=100)  # ✅ OPCIONAL
    application_date: date
    administration_route: Optional[AdministrationRouteEnum] = None  # ✅ OPCIONAL
